...
<div class="header">
      ...
      <ul class="main">
        ...
        <li><a   id="active"  href="#places">places <i class="fas fa-caret-down"></i></a>
         ...
         <ul class="dropdown">
              ...
              <li><a  id="active" href="Gonder.php">Gonder</a></li>
 ...
 <h3>Gonder</h3>
        <p>Known for its remarkable collection of crumbling castles, fortifications and 17th century churches, Gonder is often referred to as the “Camelot of Africa”. This small city in the Amhara region of northern Ethiopia was the home to many emperors who ruled the country from the 12th century to the last decade of the 20th century.
        </p>
      </div>
        </div>
...
<div class="big-text">
     <h1>Things to do in Gonder</h1>
   </div>
         <section class="about" id="about">
   

      <div class="content">
        <h3>Visit the Royal Enclosure (Fasil Ghebbi)</h3>
        <p>
...
Gonder was the political epicentre of Ethiopia for hundreds of years, and the castles that remain offer a window into a bygone era, Although many of the stories from this time are forever lost, your guide can talk you through what we do know of the events, the people, and mystery of this fascinating town. 
       ...
       The castles can be explored in a couple of hours in the morning or afternoon.
         ...
         <div class="image2">
        <img src="images/gonder-img-1.jpg" alt="" />
      </div>
    </section>
      ...
      <div class="swiper places-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/gonder-img-2.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box second"
              style="background: url(images/gonder-img-3.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/gonder-img-4.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/gonder-img-5.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/gonder-img-6.jpg) no-repeat"
            >
