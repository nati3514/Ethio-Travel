      ...
      <ul class="main">
        ...
        <li><a id="active"  href="#places">places <i class="fas fa-caret-down"></i></a>
         ...
         <ul class="dropdown">
              ...
              <li><a id="active" href="Harar.php">Harar</a></li>
...
<div class="big-text">
     <h1>Things to do</h1>
      ...
      <div class="content">
        <h3>Visit the Harar Jugol wall</h3>
        <p>
...
Still intact, the Jugol wall has become an icon of the city. 
         ...
         <div class="image2">
        <img src="images/harar-img-1.jpg" alt="" />
      </div>
    </section>
      ...
      <div class="swiper places-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/harar-img-2.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box second"
              style="background: url(images/harar-img-3.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/harar-img-4.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/harar-img-5.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/harar-img-6.jpg) no-repeat"
            >
