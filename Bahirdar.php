...
<div class="header">
      ...
      <ul class="main">
        ...
        <li><a  id="active" href="#places">places <i class="fas fa-caret-down"></i></a>
         ...
         <ul class="dropdown">
              ...
              <li><a id="active" href="Bahirdar.php">Bahirdar</a></li>
 ...
 <h3>Bahir Dar</h3>
        <p>Situated on the outskirts of the famous Lake Tana, 600km north of Addis Ababa, Bahir Dar is the third largest and arguably the most beautiful city in Ethiopia. As the capital for the regional state of Amhara, the city is home for historic monasteries, charming lodges, exotic fish markets, beautiful lakes and of course the famous Blue Nile Falls.
        </p>
      </div>
        </div>
...
<div class="big-text">
     <h1>Things To Do in Bahir Dar</h1>
   </div>
         <section class="about" id="about">
   

      <div class="content">
        <h3>Visit Lake Tana</h3>
        <p>

45 minutes in from your flight from Addis Ababa to Bahir Dar, you will notice one of East Africa’s prominent natural jewels, Lake Tana. 84km in length, 66km in width, 15 meters deep and at an elevation of 1,788 meters, this vast body of water is the largest lake in Ethiopia. 
        </p>
        <p>
       Located in a depression of the north-west plateau, Lake Tana is home to about 37 islands and peninsulas, where some of the world’s oldest churches and monasteries are found, the most famous being the Kebran Gabriel. Kebran Gabriel is believed to have been built in the 14th century and contains a museum with old paintings and manuscripts. It is important to note this monastery is only open to male visitors
         ...
         <div class="image2">
        <img src="images/bahirdar-img-1.jpg" alt="" />
      </div>
    </section>
      ...
      <div class="swiper places-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/bahirdar-img-2.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box second"
              style="background: url(images/bahirdar-img-3.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/bahirdar-img-4.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/bahirdar-img-5.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/bahirdar-img-6.jpg) no-repeat"
            >
