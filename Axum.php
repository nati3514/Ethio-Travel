...
<div class="header">
        ...
        <li><a  id="active" href="#places">places <i class="fas fa-caret-down"></i></a>
         ...
         <ul class="dropdown">
              ...
              <li><a href="Gonder.php">Gonder</a></li>
               <li><a  id="active" href="Axum.php">Axum</a></li>
 ...
 <h3>Axum</h3>
        <p>The original capital of Ethiopia, Axum was once a hugely influential city back in the days of the Axumite empire. Its glory days are long gone, but the relics that remain from that time are fascinating, and it's one of the most culturally significant regions of Ethiopia.
        </p>
      </div>
        </div>
...
<div class="big-text">
     <h1>Exploring the City</h1>
   </div>
         <section class="about" id="about">
   

      <div class="content">
        <h3>Axum, at a glance</h3>
        <p>
...
Axum is less built up than many of the other towns in the north of Ethiopia, and the lack of quality hotels here mean most visits are kept to just one night. 
        </p>
       
      </div>

         <div class="image2">
        <img src="images/axum-img-1.jpg" alt="" />
      </div>
    </section>
      ...
      <div class="swiper places-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/axum-img-2.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box second"
              style="background: url(images/axum-img-3.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/axum-img-4.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/axum-img-5.jpg) no-repeat"
            >
          ...
          <div class="swiper-slide">
            <div
              class="box"
              style="background: url(images/axum-img-6.jpg) no-repeat"
            >
