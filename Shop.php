...
<section class="packages" id="packages">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias officiis dolorem, aliquam neque.</p>
                <div class="stars">
 ...
 <div class="box">
            ...
            <div class="content">
                ...
                <div class="price"> $110.00 <span>$200.00</span> </div>
                <a href="login.php" class="btn">book now</a>
            </div>
        </div>
        <div class="box">
        ...
        <div class="box">
            ...
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> bale mountains </h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price"> $99.99 <span>$150.00</span> </div>
                <a href="login.php" class="btn">book now</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price"> $60.00 <span>$110.00</span> </div>
                <a href="login.php" class="btn">book now</a>
            </div>
        </div>
